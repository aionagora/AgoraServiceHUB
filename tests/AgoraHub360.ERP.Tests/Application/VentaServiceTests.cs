...
public class VentaServiceTests
{
    ...
    private class FakeCxcService : ICuentasPorCobrarService
    {
        ...
        public Task<Result<List<CuentaPorCobrarResumenDto>>> GetAllAsync(CuentaPorCobrarFilterDto? filter = null, CancellationToken ct = default)
            => Task.FromResult(Result<List<CuentaPorCobrarResumenDto>>.Success(new List<CuentaPorCobrarResumenDto>()));
