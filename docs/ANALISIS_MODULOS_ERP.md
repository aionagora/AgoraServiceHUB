...
| **Ventas** | _(sin código)_ | `Web/Pages/Ventas/Facturas.razor`, `Pedidos.razor` | _(sin controller de ventas)_ | 🚧 Placeholder | UI muestra "Módulo en construcción"; **sin entidades de dominio ni controller propio** |
