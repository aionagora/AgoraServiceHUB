...
{
    Task<Result<IReadOnlyList<CategoryDto>>> GetAllAsync(long? catalogId = null, CancellationToken ct = default);
    Task<Result<IReadOnlyList<CategoryDto>>> GetByCatalogAsync(long catalogId, CancellationToken ct = default);
